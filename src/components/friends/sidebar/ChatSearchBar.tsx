...
import { MessagesSquare, Search, UserPlus, MessageSquarePlus, UsersRound } from "lucide-react";
...
export default function ChatSearchBar({ value, onChange, onAddFriend, onNewMessage, onCreateRoom, onRequests }: Props) {
  return (
